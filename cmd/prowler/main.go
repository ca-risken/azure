...
type AppConfig struct {
	...
	// prowler
	PROWLER_COMMAND       string `split_words:"true" default:"prowler"`
...
func main() {
	...
	prc := prowler.NewProwlerClient(appLogger, conf.PROWLER_COMMAND, conf.AzureClientID, conf.AzureTenantID, conf.AzureClientSecret)
